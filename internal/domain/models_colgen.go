...
func NewCategories(in []db.Category) Categories { return maps.MapP(in, NewCategory) }
...
func NewNewsList(in []db.News) NewsList { return maps.MapP(in, NewNews) }
...
func NewTags(in []db.Tag) Tags { return maps.MapP(in, NewTag) }
