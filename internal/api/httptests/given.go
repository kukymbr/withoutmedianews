...
func givenCategoryAccidents() Category {
	return Category{
		ID:    1,
		Title: "Accidents",
	}
...
func givenNews1() News {
	return News{
		...
		Category:  givenCategoryAccidents(),
		Tags:      []Tag{givenTagMascots()},
	}
}

func givenNewsListable1() NewsListable {
	return NewsListable{
		ID:        1,
		Title:     "Drunk cat occurred massive traffic jam in the LA",
		Author:    "Bob the Cat",
